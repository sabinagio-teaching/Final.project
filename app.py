...
with right:
    ...
    """, unsafe_allow_html=True)
    st.markdown("**Weather Mode**: Displays the current weather condition used in the simulation. Weather influences transmission line stress, renewable output, and grid stability.")
    ...
    """, unsafe_allow_html=True)
    st.markdown("**Total Demand**: Total electricity consumption across the simulated grid, measured in gigawatts (GW). It reflects the current load required by all nodes.")
